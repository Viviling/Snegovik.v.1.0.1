...
public class MyDraw extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(this.getWidth() * 3 / 4, getHeight() * 3 / 4 + 40, 100, paint);
        canvas.drawCircle(this.getWidth() * 3 / 4, getHeight() * 3 / 4 - 115, 75, paint);
        canvas.drawCircle(this.getWidth() * 3 / 4, getHeight() * 3 / 4 - 230, 50, paint);
        canvas.drawRect(0, this.getHeight() - 10, this.getWidth(), this.getHeight(), paint);
        paint.setColor(0x85FF0012);
        canvas.drawCircle(this.getWidth() * 3 / 4 - 20, getHeight() * 3 / 4 - 240, 7, paint);
        canvas.drawCircle(this.getWidth() * 3 / 4 + 20, getHeight() * 3 / 4 - 240, 7, paint);
        paint.setColor(Color.BLACK);
        canvas.drawCircle(this.getWidth() * 3 / 4 - 20, getHeight() * 3 / 4 - 240, 2, paint);
        canvas.drawCircle(this.getWidth() * 3 / 4 + 20, getHeight() * 3 / 4 - 240, 2, paint);
        paint.setStyle(Paint.Style.FILL_AND_STROKE);

        final RectF oval = new RectF();
        oval.set(this.getWidth() * 3 / 4 - 30, getHeight() * 3 / 4 - 180 - 30, this.getWidth() * 3 / 4 + 30, getHeight() * 3 / 4 - 180 + 30);
